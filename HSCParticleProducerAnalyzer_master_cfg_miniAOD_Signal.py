...
# defaults
options.outputFile = 'Histos_S_.root'
...
if options.isData:
    ...
    if options.year>2018:
        options.GTAG = '124X_mcRun3_2022_realistic_v12'     # not sure
    else:
        options.GTAG = '106X_upgrade2018_realistic_v11BasedCandidateTmp_2022_08_09_01_32_34'
...
########################################################################
triggerList=[]
if (options.isData and options.year == 2017):
    triggerList=[
        ...
        "HLT_IsoMu27_v"]
elif (options.isData and options.year == 2018):
    triggerList=[
        "HLT_PFMET120_PFMHT120_IDTight_v",
        "HLT_Mu50_v",
        "HLT_PFHT500_PFMET100_PFMHT100_IDTight_v",
...
process.HSCParticleAnalyzer.DeDxTemplate = 'GiTemplate_EtaExtension_SatNewCorr_MC_all.root'
