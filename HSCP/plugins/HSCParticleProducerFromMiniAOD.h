...
class HSCParticleProducerFromMiniAOD : public edm::EDFilter {
  ...
  private:
    ...
    std::vector<susybsm::HSCParticle> getHSCPSeedCollection(edm::Handle<reco::TrackCollection>& trackCollectionHandle,  edm::Handle<pat::MuonCollection>& muonCollectionHandle, edm::Handle<pat::MuonCollection>& MTmuonCollectionHandle);
