...
process.dedxHitInfo.minTrackPt = cms.double(0.5)
...
#    fileNames = cms.untracked.vstring('file:/opt/sbg/data/safe1/cms/ccollard/HSCP/CMSSW_9_4_3/src/10024.0_TTbar_13+TTbar_13TeV_TuneCUETP8M1_2017_GenSimFull+DigiFull_2017+RecoFull_2017+ALCAFull_2017+HARVESTFull_2017/step2.root'),
#    fileNames = cms.untracked.vstring('file:/opt/sbg/data/safe1/cms/ccollard/HSCP/CMSSW_9_4_3/src/10024.0_TTbar_13+TTbar_13TeV_TuneCUETP8M1_2017_GenSimFull+DigiFull_2017+RecoFull_2017+ALCAFull_2017+HARVESTFull_2017/step2_gluino.root'),
    fileNames = cms.untracked.vstring('file:/opt/sbg/cms/ui3_data1/ccollard/HSCP/gluino2400_step2/step2_gluino_2.root'),
#    fileNames = cms.untracked.vstring('file:/opt/sbg/cms/ui3_data1/ccollard/HSCP/ttbar/step2.root'),
...
#    fileName = cms.string('test_stage.root')
    fileName = cms.string('/opt/sbg/cms/ui3_data1/ccollard/HSCP/gluino2400_step3/stage_from_step2_gluino_2.root')
#    fileName = cms.string('/opt/sbg/cms/ui3_data1/ccollard/HSCP/ttbar/stage_from_step2_ttbar.root')
)
...
process.ntuplizer_step = cms.Path(process.stage)



# Schedule definition
process.schedule = cms.Schedule(process.raw2digi_step,process.L1Reco_step,process.reconstruction_step,process.ntuplizer_step)
